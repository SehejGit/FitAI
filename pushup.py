...
def main():
    """
    Main function to run the pushup analysis as a script
    """
    import argparse
    
    parser = argparse.ArgumentParser(description='Analyze pushup form from a video.')
    parser.add_argument('input_video', type=str, help='Path to the input video file')
    parser.add_argument('--output', type=str, help='Path where the analyzed video will be saved')
    
    args = parser.parse_args()
    
    result = analyze_pushup(args.input_video, args.output)
